...
export const mockChannels: Channel[] = [
  ...
  { id: 'c-app-dm-sy', projectId: 'p-app', name: '신유진', type: 'dm', memberIds: ['u-jk', 'u-sy'], unreadCount: 2 },
  ...
  { id: 'c-simsec-dm-jy', projectId: 'p-sim-sec', name: '박준영', type: 'dm', memberIds: ['u-jk', 'u-jy'], unreadCount: 0 },
]
